...
//*****************************************************************************************************************************************************//
			...
			for(;lit!=lend;){    // start verification loop
				...
				if ( ((*lit).getnature()).compare("is")== 0) {  //authorized lexeme
 						
						 if ( ((*previous_lexeme).getnature()).compare("id")== 0) {  //authorized lexeme
 					      ++lit,++previous_lexeme,++next_lexeme; // lexeme == when
 					     	do{
						 		  if ( ((*lit).getnature()).compare("when")== 0){
						 		  	 ++lit,++previous_lexeme,++next_lexeme;
										...
										if ( ((*lit).getnature()).compare("id")== 0){
												...
												if ( ((*lit).getnom()).compare("=>")== 0){
											      	...
											      	do{
											      		...
											      		if ( ((*lit).getnature()).compare("id")== 0){
											      			++lit,++previous_lexeme,++next_lexeme;
											      			if ( ((*lit).getnom()).compare(":=")== 0 || ((*lit).getnom()).compare("<=")== 0 ) {
											      		    	++lit,++previous_lexeme,++next_lexeme;
											      		        id_level:;
															  	if ( ((*lit).getnature()).compare("id")== 0 || ((*lit).getnature()).compare("chiffre")== 0 || ((*lit).getnature()).compare("nombre")== 0){
											      		         ++lit,++previous_lexeme,++next_lexeme;
											      		         while((*lit).getnom()).compare(";")!= 0){
											      		          if ( ((*lit).getnature()).compare("op_arith")== 0){
																	 ++lit,++previous_lexeme,++next_lexeme;
																	 goto id_level; 	
																 	}
																 else{											         		
													  ...
													  }while ( ((*lit).getnom()).compare("when")!= 0);
												}
												else{
					      		  					cout << "error at specified lexem";		
					    			 				(*previous_lexeme).getposition();
					      ...
					      } while ((*nextlexeme).getnom()).compare("others")!=0));
					      ++lit,++previous_lexeme,++next_lexeme;
					      	if ( ((*lit).getnom()).compare("<=")== 0){
							  ++lit,++previous_lexeme,++next_lexeme;
							            do {
											      			...
											      			if ( ((*lit).getnom()).compare(":=")== 0 || ((*lit).getnom()).compare("<=")== 0 ) {
											      		       ...
											      		       id_level_others:;
															  	if ( ((*lit).getnature()).compare("id")== 0 || ((*lit).getnature()).compare("chiffre")== 0 || ((*lit).getnature()).compare("nombre")== 0){
											      		         ++lit,++previous_lexeme,++next_lexeme;
											      		         while((*lit).getnom()).compare(";")!= 0){
											      		          if ( ((*lit).getnature()).compare("op_arith")== 0 || ((*lit).getnature()).compare("op_logi")== 0|| ((*lit).getnom()).compare("<=")== 0 || ((*lit).getnature()).compare("op_ratio")== 0){
																	 ++lit,++previous_lexeme,++next_lexeme;
																	 goto id_level_others; 	
																 	}
																 else{											         		
											         				cout << "error at specified lexem";		
					    			 								(*previous_lexeme).getposition();
										...
										}while( ((*lit).getnom()).compare("end")!= 0);
										if ( ((*nexelexeme).getnom()).compare("case")!= 0){
											cout << "error at specified lexem";		
					    			 		(*previous_lexeme).getposition();
						     				goto sortie_erreur;
										}
